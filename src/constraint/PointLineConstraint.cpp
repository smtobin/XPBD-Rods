...
PointLineConstraint::GradientMatType PointLineConstraint::gradient(bool update_cache) const
{
    ...
    else
    {
        if (update_cache)
        {
            _cached_gradients[0] = SingleParticleGradientMatType::Zero();
            _cached_gradients[1] = SingleParticleGradientMatType::Zero();
            _cached_gradients[2] = SingleParticleGradientMatType::Zero();
        }
    }
