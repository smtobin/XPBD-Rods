...
RevoluteJointConstraint::ConstraintVecType RevoluteJointConstraint::evaluate() const
{
    ...
    // const Vec3r joint_axis1 = _oriented_particles[0]->orientation * _or1.col(2);
    // const Vec3r joint_axis2 = _oriented_particles[1]->orientation * _or2.col(2);
...
RevoluteJointConstraint::GradientMatType RevoluteJointConstraint::gradient() const
{
...
OneSidedRevoluteJointConstraint::OneSidedRevoluteJointConstraint(
    ...
    : XPBDConstraint<5,1,0>({particle}, AlphaVecType::Zero()), _base_pos(base_pos), _base_or(base_or), _r1(joint_pos), _or1(joint_or)
{
...
OneSidedRevoluteJointConstraint::GradientMatType OneSidedRevoluteJointConstraint::gradient() const
{
    GradientMatType grad;
    // gradients of positional constraints
...
NormedOneSidedRevoluteJointConstraint::GradientMatType NormedOneSidedRevoluteJointConstraint::gradient() const
{
    GradientMatType grad;
    // gradients of positional constraints
    const Vec3r joint_pos = _oriented_particles[0]->position + _oriented_particles[0]->orientation * _r1;
