...
void RodGraspingSimulation::notifyLeftMouseButtonPressed()
{
    ...
    if (_grasping)
    {
        ...
        auto remove_attachment_constraint_callback = 
            [this]() -> void {
                this->_grasped_rod->removeOneSidedFixedJointConstraint(this->_grasped_rod_node_index, this->_grasping_constraint);
...
void RodGraspingSimulation::_graspClosestNode()
{
    ...
    auto add_attachment_constraint_callback = 
        [this]() -> void {
            this->_grasping_constraint = this->_grasped_rod->addOneSidedFixedJointConstraint(
